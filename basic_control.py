...
while True:
    ...
    speed = 0.4 # TODO: You should overwrite this value
    ...
    print(f"distance_to_road_center:{distance_to_road_center}, angle_from_straight_in_rads:{lane_pose.angle_rad},speed:{env.speed}")
